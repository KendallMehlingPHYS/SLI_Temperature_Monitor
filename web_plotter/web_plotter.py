...
import datetime
import json
from functions import get_temp_avg, get_temp_std
...
### This fucntion was used in the original code but I am currently not using it. ###
datetime_fmt = '%Y.%m.%d'
...
def plot():
    ...
    if (len(temps_1["Temp1"]) < 100 or use_all_data == True):
        ...
        time_window = 100 # changes how much data to plot
    ...
    #Designed currently for 8 different sensors. 
